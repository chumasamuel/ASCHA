		...
		<div class="nav-header">
            <a href="index.html" class="brand-logo">
				...
				<div class="brand-title">
					<h2 class="">ASCHA</h2>
					<span class="brand-sub-title">Desenvolvido por Samuel Chuma</span>
				</div>
            </a>
                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="images/ASCHA.png" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">ASCHA HOME
						</a>
                        <ul aria-expanded="false">
							<li><a href="SobreASCHA.php">Sobre ASCHA</a></li>
							<li><a href="index-2.html">Sobre Violência</a></li>
							<li><a href="project-page.html">Igualdade de género </a></li>
							<li><a href="contacts.html">Normas sociais</a></li>
							<li><a href="kanban.html">Poder</a></li>	
						</ul>
